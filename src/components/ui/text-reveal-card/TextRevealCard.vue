<template>
    <div
        ref="cardRef"
        :class="[
            'relative w-full max-w-[40rem] overflow-hidden p-4 md:p-8 sm:p-6',
            props.class,
        ]"
    ...
    >
        ...
        <div class="relative flex h-40 items-center overflow-hidden">
            ...
            <div
                class="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)] w-full"
            >
