<template>
    ...
    >
        <h1
            class="relative z-20 text-center text-4xl font-bold text-black lg:text-9xl md:text-7xl dark:text-white"
        >
            MetaPalace
        </h1>
        ...
        <p
            class="absolute bottom-12 text-black/70 dark:text-white/70 text-sm md:text-base animate-bounce"
        >
            点击探索文物的数字世界
        </p>
    </div>
